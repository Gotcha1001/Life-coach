...
export default function DeadlineTracker({
  ...
  // Date.now() is impure, so it can't be called directly in the component
  // body. useState's lazy initializer is the React-sanctioned place for a
  // one-time impure read at mount (same pattern used for things like
  // Math.random()-generated ids).
