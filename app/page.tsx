...
// ─── Intake form (signed in, no active session) ───────────────────────────────
...
export default function HomePage() {
  ...
  // While Clerk hydrates, show nothing (avoids flash)
  if (!isLoaded) return null;

  // Not signed in → marketing landing
  if (!isSignedIn) return <LandingHero />;

  // Signed in → show intake form; on complete, navigate to plan page
